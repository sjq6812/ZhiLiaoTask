package com.wzvtc.zhiliaotask.view;
...
public class ColorChangeView extends View {
    ...
    public ColorChangeView(Context context, AttributeSet attrs) {
        ...
        mTextSize = ta.getDimensionPixelSize(
                R.styleable.ColorChangeView_text_size, mTextSize);
        mTextOriginColor = ta.getColor(
                R.styleable.ColorChangeView_text_origin_color, mTextOriginColor);
        mTextChangeColor = ta.getColor(
                R.styleable.ColorChangeView_text_change_color, mTextChangeColor);
